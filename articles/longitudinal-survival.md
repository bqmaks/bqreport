...
#>   <chr>                     <chr>      <chr>     <chr>         <chr>            
#> 1 analysis_64f5ecf77d35065c score_cha… arm       NA            NA               
#> 2 analysis_64f5ecf77d35065c score_cha… arm       NA            NA               
#> 3 analysis_64f5ecf77d35065c score_cha… arm       NA            NA               
#> 4 analysis_64f5ecf77d35065c score_cha… arm       NA            NA               
#> 5 analysis_64f5ecf77d35065c score_cha… arm       NA            NA               
#> 6 analysis_64f5ecf77d35065c score_cha… arm       NA            NA               
...
#> 1 analysis_64f5ecf… score_… arm       contrast_6… Control… Control@… Control@V0 
#> 2 analysis_64f5ecf… score_… arm       contrast_c… Control… Control@… Control@V0 
#> 3 analysis_64f5ecf… score_… arm       contrast_b… Treatme… Treatmen… Treatment@…
#> 4 analysis_64f5ecf… score_… arm       contrast_f… Treatme… Treatmen… Control ch…
#> 5 analysis_64f5ecf… score_… arm       contrast_f… Treatme… Treatmen… Treatment@…
#> 6 analysis_64f5ecf… score_… arm       contrast_d… Treatme… Treatmen… Control ch…
...
#>  1 analysis_d6… os      arm   Control         3      6       1        0    0.833
#>  2 analysis_d6… os      arm   Control         6      3       1        1    0.667
#>  3 analysis_d6… os      arm   Control         9      1       1        1    0.333
#>  4 analysis_d6… os      arm   Treatment       3      5       1        0    0.833
#>  5 analysis_d6… os      arm   Treatment       6      5       1        0    0.667
#>  6 analysis_d6… os      arm   Treatment       9      4       1        0    0.5  
#>  7 analysis_d6… os      arm   Control         3      6       1        0    0.167
#>  8 analysis_d6… os      arm   Control         6      3       1        1    0.333
#>  9 analysis_d6… os      arm   Control         9      1       1        1    0.667
#> 10 analysis_d6… os      arm   Treatment       3      5       1        0    0.167
#> 11 analysis_d6… os      arm   Treatment       6      5       1        0    0.333
#> 12 analysis_d6… os      arm   Treatment       9      4       1        0    0.5  
#> 13 analysis_d6… os      arm   Control        NA     NA      NA       NA    8    
#> 14 analysis_d6… os      arm   Treatment      NA     NA      NA       NA   11    
#> 15 analysis_d6… os      arm   Control        NA     NA      NA       NA    4    
#> 16 analysis_d6… os      arm   Control        NA     NA      NA       NA    8    
#> 17 analysis_d6… os      arm   Treatment      NA     NA      NA       NA    6    
#> 18 analysis_d6… os      arm   Treatment      NA     NA      NA       NA   11    
#> 19 analysis_d6… os      arm   Control        NA     NA      NA       NA    6.83 
#> 20 analysis_d6… os      arm   Treatment      NA     NA      NA       NA    7.33 
...
#>   analysis_id               outcome predictor stratum_label transformation_id
#>   <chr>                     <chr>   <chr>     <chr>         <chr>            
#> 1 analysis_dd5f4c6a2a7498a7 os      arm       NA            NA               
#> 2 analysis_dd5f4c6a2a7498a7 os      arm       NA            NA               
#> # ℹ 17 more variables: transformation_label <chr>, term <chr>, level <chr>,
#> #   estimate <dbl>, std_error <dbl>, std_error_scale <chr>, conf_low <dbl>,
#> #   conf_high <dbl>, statistic <dbl>, df <dbl>, p_value <dbl>,
#> #   effect_measure <chr>, scale <chr>, n <int>, n_events <int>, method <chr>,
...
#>   <chr>                     <chr>  <dbl> <chr>    <chr>  
#> 1 analysis_dd5f4c6a2a7498a7 arm    0.212 observed NA     
#> 2 analysis_dd5f4c6a2a7498a7 age    0.106 observed NA     
#> 3 analysis_dd5f4c6a2a7498a7 GLOBAL 0.224 observed NA
```
