...
Unnamed vectors follow factor-level order. Named vectors map levels explicitly,
and functions may generate a palette from the current levels. The resolved
mapping is snapshotted in the analysis plan.
